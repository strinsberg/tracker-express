...
$(PROGRAM_SERVER):
	$(CXX) $(CXXFLAGS) -o $(PROGRAM_SERVER) -I $(SRC_INCLUDE) $(SRC_DIR_SERVER)/main.cpp $(SRC_DIR_SERVICE)/*.cpp $(LINKFLAGS)


$(PROGRAM_TEST):
	$(CXX) $(CXXFLAGS) -o $(PROGRAM_TEST) $(INCLUDE) $(TEST_DIR)/*.cpp $(SRC_DIR_SERVICE)/*.cpp $(LINKFLAGS) $(LINKFLAGS_TEST) $(GMOCK)
	$(PROGRAM_TEST)
